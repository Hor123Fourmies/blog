...
<header>
    <nav class="navText">
        <ul>
            ...
            <li>|</li>
            <li class="navText"><a href="destLointaine.php" class="enCours">Destinations lointaines</a></li>
            <li>|</li>
...
if ($conn->connect_error) {
    ...
    $sql = "SELECT id, theme, titre, contenu, DATE_FORMAT(date, '%d-%m-%Y') as date, image FROM articles WHERE theme = 'destLoin' ORDER BY id DESC";
